...
func ScheduleRoutes(r *gin.RouterGroup, h *handlers.ClassScheduleHandler) {
	// public-endpoints
	r.GET("/api/v1/schedules", h.GetAllClassSchedules)

	// customer-endpoints
	customer := r.Group("/api/v1/schedules")
	...
	instructor := r.Group("/api/v1/instructor/schedules")
	...
	// admin-endpoints
	admin := r.Group("/api/v1/admin/schedules")
